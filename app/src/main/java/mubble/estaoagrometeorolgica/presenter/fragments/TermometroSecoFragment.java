 ...
 */
public class TermometroSecoFragment extends Fragment {
    ...
    public TermometroSecoFragment(){}

    public static TermometroSecoFragment newInstance(String dataInicial, String dataFinal) {
        TermometroSecoFragment termometroSecoFragment = new TermometroSecoFragment();
        Bundle args = new Bundle();
        args.putString("dataInicial", dataInicial);
        args.putString("dataFinal", dataFinal);
        termometroSecoFragment.setArguments(args);

        return termometroSecoFragment;
    }
    ...
    private void carregarGrafico(){
        ConsultaDadosPresenter.getInstancia(activity).getGraficoTermometroSeco(
