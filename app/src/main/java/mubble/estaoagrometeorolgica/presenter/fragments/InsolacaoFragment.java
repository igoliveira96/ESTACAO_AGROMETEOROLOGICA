 ...
 */
public class InsolacaoFragment extends Fragment {
    ...
    public InsolacaoFragment(){}

    public static InsolacaoFragment newInstance(String dataInicial, String dataFinal) {
        InsolacaoFragment insolacaoFragment = new InsolacaoFragment();
        Bundle args = new Bundle();
        args.putString("dataInicial", dataInicial);
        args.putString("dataFinal", dataFinal);
        insolacaoFragment.setArguments(args);

        return insolacaoFragment;
    }
    ...
    private void carregarGrafico(){
        ConsultaDadosPresenter.getInstancia(activity).getGraficoInsolacao(
