...
public class PrecipitacaoTimeLineFragment extends Fragment {
    ...
    public PrecipitacaoTimeLineFragment(){}

    public static PrecipitacaoTimeLineFragment newInstance(String dataInicial, String dataFinal) {
        PrecipitacaoTimeLineFragment fragment = new PrecipitacaoTimeLineFragment();
    ...
    private void carregarDados(){
        ConsultaDadosPresenter.getInstancia(activity).getTimeLinePrecipitacao(
