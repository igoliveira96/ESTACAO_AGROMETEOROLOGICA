 ...
 */
public class UmidadeRelativaArFragment extends Fragment {
    ...
    public UmidadeRelativaArFragment(){}

    public static UmidadeRelativaArFragment newInstance(String dataInicial, String dataFinal) {
        UmidadeRelativaArFragment fragment = new UmidadeRelativaArFragment();
    ...
    private void carregarGrafico(){
        ConsultaDadosPresenter.getInstancia(activity).getGraficoUmidadeRelativaAr(
