 ...
 */
public class UmidadeRelativaArTimeLineFragment extends Fragment {
    ...
    public UmidadeRelativaArTimeLineFragment(){}

    public static UmidadeRelativaArTimeLineFragment newInstance(String dataInicial, String dataFinal) {
        UmidadeRelativaArTimeLineFragment timeLineFragment = new UmidadeRelativaArTimeLineFragment();
    ...
    private void carregarDados(){
        ConsultaDadosPresenter.getInstancia(activity).getTimeLineUmidadeRelativaAr(
