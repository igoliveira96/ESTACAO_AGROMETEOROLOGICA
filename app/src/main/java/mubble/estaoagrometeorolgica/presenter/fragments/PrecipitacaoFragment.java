...
public class PrecipitacaoFragment extends Fragment {
    ...
    public PrecipitacaoFragment(){}

    public static PrecipitacaoFragment newInstance(String dataInicial, String dataFinal) {
        PrecipitacaoFragment fragment = new PrecipitacaoFragment();
    ...
    private void carregarGrafico(){
        ConsultaDadosPresenter.getInstancia(activity).getGraficoPrecipitacao(
