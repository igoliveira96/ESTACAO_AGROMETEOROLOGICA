...
/**
 * Criado por Igor Goulart de Oliveiram em 02/06/2018.
 */
public class EvaporacaoTimeLineFragment extends Fragment {
    ...
    public EvaporacaoTimeLineFragment(){}

    public static EvaporacaoTimeLineFragment newInstance(String dataInicial, String dataFinal) {
        EvaporacaoTimeLineFragment fragment = new EvaporacaoTimeLineFragment();
    ...
    private void carregarDados(){
        ConsultaDadosPresenter.getInstancia(activity).getTimeLineEvaporacao(
