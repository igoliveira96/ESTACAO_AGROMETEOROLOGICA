 ...
 */
public class InsolacaoTimeLineFragment extends Fragment {
    ...
    public InsolacaoTimeLineFragment(){}

    public static InsolacaoTimeLineFragment newInstance(String dataInicial, String dataFinal) {
        InsolacaoTimeLineFragment insolacaoTimeLineFragment = new InsolacaoTimeLineFragment();
        Bundle args = new Bundle();
        args.putString("dataInicial", dataInicial);
        args.putString("dataFinal", dataFinal);
        insolacaoTimeLineFragment.setArguments(args);

        return insolacaoTimeLineFragment;
    }
    ...
    private void carregarDados(){
        ConsultaDadosPresenter.getInstancia(activity).getTimeLineInsolacao(
