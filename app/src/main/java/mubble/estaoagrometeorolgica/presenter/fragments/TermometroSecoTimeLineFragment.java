 ...
 */
public class TermometroSecoTimeLineFragment extends Fragment {
    ...
    public TermometroSecoTimeLineFragment(){}

    public static TermometroSecoTimeLineFragment newInstance(String dataInicial, String dataFinal) {
        TermometroSecoTimeLineFragment timeLineFragment = new TermometroSecoTimeLineFragment();
    ...
    private void carregarDados(){
        ConsultaDadosPresenter.getInstancia(activity).getTimeLineTermometroSeco(
